...
#Scrapingant Proxy: "fb2b8e23328d45a8927f3dde0d434594" "https://api.scrapingant.com/v2/general?" {"url": url, "x-api-key": API_KEY}
...
class GermancarforumspiderSpider(scrapy.Spider):
    ...
    def start_requests(self):
        start_url = "https://www.germancarforum.com/"
...
# IN MAIN PAGE:
    ...
    def parse(self, response):
        ...
        for sl in sub_section_link:
            ...
            # excluded_urls = ["/buysell/", "/forums/resource-discussions.105/", "/forums/off-topic.108/", "/forums/in-the-news.449/"]
            # if relative_sub_section_url not in excluded_urls:
            #     sl_url = "https://www.germancarforum.com" + relative_sub_section_url
            if relative_sub_section_url == "forums/ferrari.187/":
                sl_url = "https://www.germancarforum.com" + relative_sub_section_url
...
# IN SUB-SECTION PAGE:
    ...
    def parse_sub_section_page(self, response):
        ...
        for tl in thread_link:
            ...
            tl_url = "https://www.germancarforum.com" + relative_thread_url
        ...
        if next_page is not None:
            # current_page = int(next_page.split("/")[-1].replace("page-", ""))

            # if current_page <= 3:
            next_page_url = "https://www.germancarforum.com" + next_page
...
# IN THREAD PAGE:
    ...
    def parse_thread_page(self, response):
        ...
        section_name = response.css('div.p-title h1::text').get().strip()
        ...
        for post in thread:
            ...
            if relative_user_profile_url is not None:
                up_url = "https://www.germancarforum.com" + relative_user_profile_url
        ...
        if next_post_page is not None:
            next_post_page_url = "https://www.germancarforum.com/" + next_post_page
